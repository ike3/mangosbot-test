...
namespace ai
{
    ...
    public:
        MockValueContext() : NamedObjectContext<UntypedValue>()
        {
            ...
            creators["defense target"] = &MockValueContext::mock;
            ...
            creators["party member without item"] = &MockValueContext::mock;
            creators["party member without food"] = &MockValueContext::mock;
            creators["party member without water"] = &MockValueContext::mock;
    ...
    public:
        AiObjectContextWrapper(PlayerbotAI* const ai, AiObjectContext *realContext) :
          AiObjectContext(ai), realContext(realContext)
          {
              ...
              GetValue<Unit*>("defense target")->Set(MockedTargets::GetTargetForDefense());
